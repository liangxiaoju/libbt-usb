 ...
 *  Copyright (C) 2012-13 Eduardo Jos? Tagle <ejtagle@hotmail.com>
 *
...
void userial_vendor_close(void)
{
    ...
    /* Bring down network */
    if (ioctl(vnd_netlink.fd, HCIDEVDOWN, vnd_netlink.dev_id) < 0) {
        ALOGE("Can't bring down network");
    }
